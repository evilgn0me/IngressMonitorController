...
# stakater/ingressmonitorcontroller-bundle:$VERSION and stakater.com/ingressmonitorcontroller-catalog:$VERSION.
IMAGE_TAG_BASE ?= stakater/ingressmonitorcontroller
